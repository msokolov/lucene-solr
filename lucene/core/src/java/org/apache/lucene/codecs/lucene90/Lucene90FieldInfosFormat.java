 ...
 *   <li>VectorNumDimensions: the number of vector dimensions. It is non-zero only if
 *       the field is indexed a vector, for example through
 *       {@link org.apache.lucene.document.VectorField}.</li>
 * </ul>
 *
 * @lucene.experimental
 */
        ...
        for (int i = 0; i < size; i++) {
          ...
          try {
            infos[i] = new FieldInfo(name, fieldNumber, storeTermVector, omitNorms, storePayloads,
                ...
                vectorNumDimensions, isSoftDeletesField);
